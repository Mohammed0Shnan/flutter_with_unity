...
class EducationLevelStepsScreen extends StatefulWidget {
  final EducationLevelBloc _bloc;
  EducationLevelStepsScreen(this._bloc);
  @override
  _EducationLevelStepsScreenState createState() => _EducationLevelStepsScreenState();
}

class _EducationLevelStepsScreenState extends State<EducationLevelStepsScreen> {
  @override
  void initState() { 
    super.initState();
